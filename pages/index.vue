    ...
    <main class="main main-toppage">
      ...
      <article class="main__container">
        ...
        <section class="main__container__wrapper main__container__company">
          ...
          <div class="main__container__service-wrapper main__container__service-wrapper__outline">
            <section class="main__container__service-wrapper__outline__inner">
              <h3>会社名</h3>
              <h1>株式会社tatepass（タテパス）</h1>
            </section>
            <section class="main__container__service-wrapper__outline__inner">
              <h3>役員</h3>
              <p>
                共同創業者：代表取締役 CEO 太田洋平<br>
                共同創業者：取締役 CTO 古市丞人
              </p>
            </section>
            <section class="main__container__service-wrapper__outline__inner">
        ...
        <section class="main__container__wrapper main__container__contact">
          ...
          <p class="main__container__service-subtitle">お問い合わせ</p>
          <p class="main__container__contact-discp">
            tatepassへのお問い合わせやご相談は、以下のフォームにご入力ください。<br>
            ご入力いただきました個人情報は弊社のプライバシーポリシーに基づき取扱を行い、厳重に管理致します。<br>
            お問い合わせやご相談につきまして、以下の点をご了承いただけますようお願い申し上げます。<br>
            ・内容によってはご回答までお時間をいただく場合やご回答が出来ない場合がございます。<br>
            ・ご本人様およびご連絡先の確認ができないお問い合わせにつきましてはご回答致しかねます。
          </p>
          <div class="main__container__wrapper__contactform">
            <contact v-on:send="onFormSubmit"/>
          </div>
        </section>
        <!--お問い合わせここまで-->
      </article>
...
.main{
  ...
  .main__eyecatch{
    ...
    .main__eyecatch-image{
      ...
      background-image: url("/sample04_02.png");
    ...
    .main__eyecatch-conts{
      ...
      */
      ...
      .main__eyecatch-conts-underlink{
        ...
        .main__eyecatch-conts-underlink span{
          padding: 1em;
...
.main__container__service-wrapper__outline{
  ...
  .main__container__service-wrapper__outline__inner{
    ...
    .main__container__service-wrapper__outline__inner h1,
    .main__container__service-wrapper__outline__inner p{
      width: 100%;
			margin: 0 auto;
			padding: 0;
			border: none;
